    ...
    <div class="container-scroller">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 font-weight-semibold"><?php echo $_SESSION['login'];?></p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="manage-doctor.php">DOCTOR TABLE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="manage-infermier.php">INFERMIER TABLE</a>
                  </li>
                </ul>
              </div>
            </li>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Manage DOCTOR</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> All DOCTOR Details </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>ID.</th>
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"select * from users WHERE type='D'");
							  $cnt=1;
