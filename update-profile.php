    ...
    <div class="container-scroller">
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Manage </h3>
				<div class="row">
      ...
      <<form class="form-horizontal style-form" name="form1" method="post" action="" onSubmit="return valid();">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">ROLE <br>  A:ADMIN  U:USER D:DOCTOR I:INFERMIER</label>
                              <div class="col-sm-10">
